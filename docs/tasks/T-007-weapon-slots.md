...
Status: **BLOCKED on T-001**. Scope: investigate candidate unused/episodic weapon slots and prove at least one can coexist with its vanilla counterpart. Extend to three only if the first is stable. No finished gold art or custom gunplay.
