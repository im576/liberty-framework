...
**Current assignment:** T-000 through T-003 passed owner gameplay checks. T-007's first custom pistol and controller menu switch passed, including total-ammo transfer. The pistol uses ID 58 and replaces the vanilla pistol in the handgun slot. The carbine/pump shotgun expansion was installed after GTA IV closed and awaits an in-game playtest. The project owner performs game playtests and alone marks a tested card `DONE`.
...
| T-007 | [Separate gold weapon slot spike](T-007-weapon-slots.md) | T-001 | NEEDS-PLAYTEST (carbine/shotgun expansion installed) |
