...
- 2026-09-24 — T-022 combat effects detection prototype built on `codex/phase2-combat`: bounded player-attributed hit sampling, GTA IV bone-region map, transient injury/wound records, limb-loss candidate gating, independent live config. Physical reactions, visible blood/wounds, and mesh dismemberment await CE API validation and original assets; owner playtest pending.
