...
- 2026-09-24 — T-025 stream C staged on `codex/phase2-systems`: stable physical weapon IDs and metadata survive body/trunk/safehouse/owned-car state; the catalog covers a vanilla sidearm pair and existing carbine. Offline checks pass; integration and owner playtest pending. T-023 vehicle body geometry remains under investigation.
